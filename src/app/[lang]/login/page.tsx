          ...
          <div className="text-center space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                {isSignUp ? dictionary.auth.sign_up : dictionary.auth.sign_in}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {isSubmitting
                  ? (isSignUp ? dictionary.auth.signing_up : dictionary.auth.signing_in)
                  : isSignUp
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-background px-2 text-muted-foreground">
                  {dictionary.auth.or_continue_with}
                </span>
              </div>
            </div>
            ...
            <p className="text-sm text-muted-foreground">
              {isSignUp ? dictionary.auth.already_have_account : dictionary.auth.dont_have_account}{" "}
              <button
                type="button"
                onClick={() => {
              ...
              >
                {isSignUp ? dictionary.auth.sign_in : dictionary.auth.sign_up}
              </button>
            </p>
          </div>
        </CardContent>
